...
In part, because it involved an Amazon company, hosted on Amazon’s cloud service, AWS. So many people host their data on AWS and might be thinking, “If Amazon can’t keep data secure on AWS, who can?” 

https://medium.com/cloud-security/thoughts-on-the-twitch-breach-a2840470387b

## Phizer

The exposed data was found on a misconfigured Google Cloud storage bucket. The data included hundreds of conversations between Pfizer’s automated customer support software and people using its prescription pharmaceutical drugs.

https://pf-media.co.uk/news/pfizer-suffers-huge-data-breach-on-unsecured-cloud-storage/#:~:text=The%20exposed%20data%20was%20found,cancer%20treatments%20Ibrance%20and%20Aromasin.
...
## Shiny Server on insecure machines
...
```
gcloud auth login --project shiny-cloud-345816
